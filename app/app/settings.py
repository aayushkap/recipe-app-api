...
SECRET_KEY = 'django-insecure-7xh4l^mfl8&n3r_zhn%j_akt2b@h3^bibfr7-4en9ej+)*)hr6'
...
# Manually updated to include 'core' app
INSTALLED_APPS = [
...
# Manually updated for PostgreSQL Integration. Env variables created in Docker-compose file
DATABASES = {
    'default': {
